...
class Error extends LoginState {
  const Error({required this.erro}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Error&&(identical(other.erro, erro) || other.erro == erro));
}
...
@override
String toString() {
  return 'LoginState.error(erro: $erro)';
}
...
/// Create a copy of LoginState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? erro = null,}) {
  return _then(Error(
erro: null == erro ? _self.erro : erro // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class Success extends LoginState {
  const Success({required this.token}): super._();
